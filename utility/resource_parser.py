...
class ResourceParser:
    ...
    def add_default_update_parameters(parser):
        ...
        parser.add_argument(Constants.JSON.token, help='User token', location='headers', required=True)
    ...
    def add_default_parameters(parser):
        parser.add_argument(Constants.JSON.token, help='User token', location='form', required=True)
