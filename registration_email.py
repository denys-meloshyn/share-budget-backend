...
# 		<p>If you did not register for Share Budget, just ignore this message.</p>
# 		<p>With any quetions contact
# 			<a href="mailto:sharebudgetproject@gmail.com?Subject=Remarks and offers">sharebudgetproject@gmail.com</a>.
# 		</p>
# 		<p>Best regards,
# 		<br>Share Budget Team</p>
...
def send_registration_email(user):
    ...
    msg.html += '<p>Thanks for joining Share Budget. To complete your registration, please, click the following link to approve your email:</p>'
    msg.html += '<p> <a href = "'
    ...
    msg.html += '<p>With any quetions contact <a href="mailto:sharebudgetproject@gmail.com?Subject=Remarks and offers">sharebudgetproject@gmail.com</a>.</p>'
